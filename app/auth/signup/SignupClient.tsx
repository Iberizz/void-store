...
export default function SignupClient() {
  ...
  return (
    <main className="min-h-screen bg-[#000000] flex">
      ...
      {/* ── Left panel — branding ── */}
      <div className="hidden lg:flex relative w-[55%] flex-col justify-between p-16 overflow-hidden"
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 md:px-16 py-12">
        <div className="w-full max-w-sm">
          ...
          <p ref={subtitleRef} className="font-sans font-light text-[#3A3A3A] text-sm mb-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              ...
              <div>
                ...
                <input
                  ...
                  autoComplete="name" placeholder="Ibrahim Nimaga"
                  className={inputCls}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  minLength={8} className={inputCls}
                />
              </div>
              ...
              <p className="font-sans text-[#1E1E1E] text-[10px] tracking-[0.05em] text-center">
                By joining, you agree to receive exclusive VØID communications.
              </p>
            </form>

            <p className="font-sans text-[#1E1E1E] text-[10px] tracking-[0.1em] text-center mt-6">
